...
(
	...
	FOREIGN KEY
		...
		FOREIGN KEY
						...
						INSERT INTO users
							(id, username, first_name, last_name, email, address, image)
						VALUES
						...
						INSERT INTO products
							(id, name, description, retail_price, product_sku, img, stock)
						VALUES
	...
	collaborations hit shelves and stormed stockrooms, including one of the greatest Air Max 1 designs of all time, the atmos x Air Max 1 ‘Safari’.', 175, 'LEB16ATSAF', 'https://c.static-nike.com/a/images/t_prod_ss/w_960,c_limit,f_auto/xarfk0z7kclteq84ypmn/nike-lebron-16-low-atmos-safari-release-date.jpg', 500),
	...
	iconic running shoe. When it introduced two different pressure systems in one Air-unit on a Nike sneaker', 140, 'AM2LBL', 'https://c.static-nike.com/a/images/t_prod_ss/w_960,c_limit,f_auto/ujgshplrq5f5gzlpo8sc/mens-air-max2-light-blue-lagoon-release-date.jpg', 500),
							(4, 'Air Jordan IX - Midnight Navy', 'There are moments in MJ’s career that shaped his legacy, and it all started with the
	game-winning shot that brought North Carolina a national title in 1982.', 190, 'AJ9MIDNAV', 'https://c.static-nike.com/a/images/t_prod_ss/w_960,c_limit,f_auto/fbtlydjbtuy4t8bee9m5/air-jordan-9-retro-unc-midnight-navy-release-date.jpg', 500),
							(5, 'Kyrie 5 - BHM', 'The Kyrie 5 “BHM” honors Kenyan culture with a vibrant embossed print on the Flytrap and rose gold swoosh at the heel.', 130, 'KY5BHM', 'https://c.static-nike.com/a/images/t_prod_ss/w_960,c_limit,f_auto/mq9iiecbkeo4rs4ufjg9/nike-kyrie-5-bhm-2019-release-date.jpg', 500),
							(6, 'Blazer Mid 77 - Habanero Red', 'Named after Portland’s basketball team when it joined the league, the Blazer became
	an instant classic on and off the court when it debuted in 1972. ', 100, 'BLZMIDHAB', 'https://c.static-nike.com/a/images/t_prod_ss/w_960,c_limit,f_auto/x1q49nrsbgdenslfdbwa/nike-blazer-mid-77-vintage-habanero-red-white-sail-release-date.jpg', 500),
							(7, 'ISPA React Low - Summit White', 'Improvise. Scavenge. Protect. Adapt. When change comes calling, the iSPA collection
	answers with assertion that any problem can be solved using materials on hand.', 160, 'REACTISPA', 'https://c.static-nike.com/a/images/t_prod_ss/w_960,c_limit,f_auto/y1yfmld1viozwu1ylakm/nike-react-runner-wr-ispa-summit-white-deep-royal-blue-black-release-date.jpg', 500),
	...
	no matter who you are. The LeBron 16 Equality Home represents LeBron’s desire to break down barriers, inspire action and bring people together.', 185, 'LEB16EQ', 'https://c.static-nike.com/a/images/t_prod_ss/w_960,c_limit,f_auto/uzpz1opv2uxviens12pn/lebron-16-equality-release-date.jpg', 500),
							(9, 'PG 3 All-Star', 'Designed to go further and push beyond limits, the PG 3 “All-Star” combines PG’s love for fishing and the outdoors with the performance innovation, vibrant heritage, and design mantra of the Nike ACG line.', 110, 'PG3AS', 'https://c.static-nike.com/a/images/t_prod_ss/w_960,c_limit,f_auto/ski6saarm5jnlrid7old/pg3-acg-multi-color-release-date.jpg', 500),
							(10, 'KD 11 - BHM', 'The KD 11 “BHM” is honors the culture of the Sierra Leone. It features a colorful purple hued upper with a traditional-inspired patterned print on the ankle.', 150, 'KD11BHM', 'https://c.static-nike.com/a/images/t_prod_ss/w_960,c_limit,f_auto/c2xjqe9fphlbmozdesmf/nike-kd-11-bhm-2019-release-date.jpg', 500),
							(11, 'Air Foamposite One - Midnight Navy', 'On its debut in 1997, the shoe adopted by Anfernee “Penny” Hardaway as his. ', 230, 'AF1MIDNAV', 'https://c.static-nike.com/a/images/t_prod_ss/w_960,c_limit,f_auto/gj2z6fvague7amfbcnpv/air-foamposite-one-midnight-navy-gum-light-brown-release-date.jpg', 500),
							(12, 'Nike Air Max 95 - Carhartt WIP', 'Nike x Carhartt WIP’s footwear collection combines iconic sneaker silhouettes
	with classic workwear materials. ', 170, 'NAM95CARWIP', 'https://c.static-nike.com/a/images/t_prod_ss/w_960,c_limit,f_auto/w5bs2nmtaphmscpbui4a/nike-air-max-95-carhartt-wip-black-sail-total-orange-release-date.jpg', 500),
							(13, 'Air Vapormax Plus - Retuned Air', 'Nike Air VaporMax. 20 years after introducing Tuned Air, heritage design meets the future of Nike Air cushioning to create the Air VaporMax Plus.', 190, 'AVPRA1', 'https://c.static-nike.com/a/images/t_prod_ss/w_960,c_limit,f_auto/dlgseca312yxqmpcajf7/nike-air-vapormax-plus-white-pure-platinum-release-date.jpg', 500),
							(14, 'React Element 55 - New Chapter', "The Nike React didn't actually hit the ground running. In its first form—this form—it was designed for casual wear, pure and simple. The React Element 55 is the opaque iteration of the React Element 87, which took comfort to the cutting edge. ", 130, 'RE55NC', "https://c.static-nike.com/a/images/t_prod_ss/w_960,c_limit,f_auto/zbgrzdzbnsufdekwwvw4/nike-react-element-55-black-white-release-date.jpg", 500),
							(15, "Why Not Zero.2 - Own The Game", "“Own the game” exemplifies his “Why Not?” ethos, and the design blends bright colors with bold patterns to ensure Russell Westbrook stands-out when he wears them on the court during All Star weekend.", 125, 'WNZ2OTH', "https://c.static-nike.com/a/images/t_prod_ss/w_960,c_limit,f_auto/sbsphwizk6cpmvrwb3r0/mens-jordan-why-not-02-all-star-release-date.jpg", 500);


						INSERT INTO orders
							(id, total, order_date, user_id, paid, payment_date, order_tracking_number)
						VALUES
